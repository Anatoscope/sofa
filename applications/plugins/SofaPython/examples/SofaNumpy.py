...
def createSceneAndController(node):
    ...
    mo = node.createObject("MechanicalObject",position="1 2 3 4 5 6",translation="1 2 3")
    ...
    print( "before (1):",mo.position[0][0] )
    mo.position[0][0] = 123
    print( "after (1):",mo.position[0][0] )
    ...
    print( "before (1):",mo.position[0][0] )
    pos[0][0] = 123
    print( "after (123):",mo.position[0][0] )
