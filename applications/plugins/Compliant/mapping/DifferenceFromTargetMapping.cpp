...
#ifndef SOFA_FLOAT
.add< DifferenceFromTargetMapping< Vec6dTypes, Vec6dTypes > >()    
...
#endif
#ifndef SOFA_DOUBLE
.add< DifferenceFromTargetMapping< Vec6fTypes, Vec6fTypes > >()    
...
#ifndef SOFA_FLOAT
template class SOFA_Compliant_API DifferenceFromTargetMapping< Vec6dTypes, Vec6dTypes >;
...
#ifndef SOFA_DOUBLE
template class SOFA_Compliant_API DifferenceFromTargetMapping< Vec6fTypes, Vec6fTypes >;
